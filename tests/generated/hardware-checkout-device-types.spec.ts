...
test.describe("Hardware Checkout Device Type Validation", () => {
    ...
    const orderRes = await request.post(`/api/sn_sc/servicecatalog/items/${catItemId}/order_now`, {
      ...
      data: {
        ...
        variables: {
              ...
              "justification": "Testing Mac Laptop checkout"
        }
      },
    });
    ...
    const orderRes = await request.post(`/api/sn_sc/servicecatalog/items/${catItemId}/order_now`, {
      ...
      data: {
        ...
        variables: {
              ...
              "justification": "Testing Windows Laptop checkout"
        }
      },
    });
    expect(orderRes.ok()).toBeTruthy();
  ...
  test("Each device type creates an auto-approved requested item (device_type=iphone, device_label=iPhone)", async ({ request }) => {
    ...
    const orderRes = await request.post(`/api/sn_sc/servicecatalog/items/${catItemId}/order_now`, {
      ...
      data: {
        ...
        variables: {
              "device_type": "iphone",
              "justification": "Testing iPhone checkout"
        }
      },
    });
    expect(orderRes.ok()).toBeTruthy();
    ...
    const orderRes = await request.post(`/api/sn_sc/servicecatalog/items/${catItemId}/order_now`, {
      ...
      data: {
        ...
        variables: {
              ...
              "justification": "Testing Android Phone checkout"
        }
      },
    });
    expect(orderRes.ok()).toBeTruthy();
